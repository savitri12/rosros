...
public class Properties {
	...
	public static String reconciliationNotPossible = "Reconciliation not possible due to cashup sheet status";
	
	public static String restaurantNotFound = "Restaurant not found for the given Id";
}
